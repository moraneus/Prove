...
#   python tools/generate_race_trace.py -n 1000   -s 42 \
#       -o experiments/Safety_Race/traces/trace_1k.csv
#   python tools/generate_race_trace.py -n 10000  -s 42 \
#       -o experiments/Safety_Race/traces/trace_10k.csv
#   python tools/generate_race_trace.py -n 100000 -s 42 \
#       -o experiments/Safety_Race/traces/trace_100k.csv
#
# Prerequisites:
...
#   bash experiments/Safety_Race/run_experiment.sh
# =============================================================================
set -uo pipefail

EXP_NAME="Safety_Race"
EXP_TAG="race"
PROP_FILE_NAME="safety_race"
PROP_FORMULA='!(TRUE S unsafe_A1A2) & !(TRUE S unsafe_A1A3) & !(TRUE S unsafe_A2A3)'
