#!/usr/bin/env bash
# =============================================================================
# Safety_Cassandra experiment runner
#
...
#   python tools/generate_cassandra_trace.py -n 1000   -s 42 \
#       -o experiments/Safety_Cassandra/traces/trace_1k.csv
#   python tools/generate_cassandra_trace.py -n 10000  -s 42 \
#       -o experiments/Safety_Cassandra/traces/trace_10k.csv
#   python tools/generate_cassandra_trace.py -n 100000 -s 42 \
#       -o experiments/Safety_Cassandra/traces/trace_100k.csv
#
# Prerequisites:
...
EXP_NAME="Safety_Cassandra"
EXP_TAG="cassandra"
PROP_FILE_NAME="safety_cass"
PROP_FORMULA='write_enrollment -> (TRUE S write_student)'
