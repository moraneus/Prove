...
#
# Property: scanning <-> @idle
# Operators: Biconditional + Yesterday
# Expected: Always SAT
#
# Prerequisites:
...
#   bash experiments/drone_swarm/exp4_phase_transition/run_experiment.sh
# =============================================================================
...
EXP_NAME="Phase Transition"
PROP_FILE_NAME="phase_transition"
PROP_FORMULA='scanning <-> @idle'
...
# Experiment 4: ${EXP_NAME}

## Property

| Formula | Operators | Expected |
|---------|-----------|----------|
| \`${PROP_FORMULA}\` | Biconditional + Yesterday | ${PROP_EXPECTED} |
