#!/usr/bin/env bash
# =============================================================================
# Experiment 3: Continuous Since
#
# Property: relative_computed -> (position_sent S position_measured)
# Operators: Implication + Since (real continuous semantics)
# Expected: Always SAT
#
# Prerequisites:
...
#   bash experiments/drone_swarm/exp3_continuous_since/run_experiment.sh
# =============================================================================
...
EXP_NAME="Continuous Since"
PROP_FILE_NAME="continuous_since"
PROP_FORMULA='relative_computed -> (position_sent S position_measured)'
PROP_EXPECTED="Always SAT"
...
# Experiment 3: ${EXP_NAME}

## Property

| Formula | Operators | Expected |
|---------|-----------|----------|
| \`${PROP_FORMULA}\` | Implication + Since | ${PROP_EXPECTED} |
