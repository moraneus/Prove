...
# Operators: Implication + Yesterday
# Expected: SAT when eps >= 2.0, VIOL when eps < 2.0
#
# Prerequisites:
...
EXP_NAME="Fragile Ordering"
PROP_FILE_NAME="fragile_ordering"
PROP_FORMULA='late_beacon -> @early_beacon'
PROP_EXPECTED="SAT when eps >= 2.0, VIOL when eps < 2.0"
...
# Experiment 1: ${EXP_NAME}

## Property

| Formula | Operators | Expected |
|---------|-----------|----------|
| \`${PROP_FORMULA}\` | Implication + Yesterday | ${PROP_EXPECTED} |
