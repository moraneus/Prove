...
#
# The ε-sensitivity threshold of this property is 0.25; the sweep
# values 0.0 and 0.5 straddle it (expect VIOL @ 0.0, SAT @ 0.5+).
#
...
#   python tools/generate_2pc_trace.py -n 1000   -s 42 \
#       -o experiments/Safety_2PC/traces/trace_1k.csv
#   python tools/generate_2pc_trace.py -n 10000  -s 42 \
#       -o experiments/Safety_2PC/traces/trace_10k.csv
#   python tools/generate_2pc_trace.py -n 100000 -s 42 \
#       -o experiments/Safety_2PC/traces/trace_100k.csv
#
# Prerequisites:
...
#   bash experiments/Safety_2PC/run_experiment.sh
# =============================================================================
set -uo pipefail

EXP_NAME="Safety_2PC"
EXP_TAG="2pc"
PROP_FILE_NAME="safety_2pc"
PROP_FORMULA='TRUE S (prepared_P3 & @vote_yes_P2)'
...
echo "  ε-threshold: 0.25 (VIOL when ε < 0.25, SAT when ε ≥ 0.25)"
echo "============================================"
